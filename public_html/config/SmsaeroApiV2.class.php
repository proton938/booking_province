...
class SmsaeroApiV2
{
    ...
    private $email = 'proton938@mail.ru'; //Ваш логин|email
    private $api_key = 'aOnOIqfE5sHlV3mhxh7CZqYB6uer'; //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
